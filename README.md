...
Updates all six command files — `/engine-init`, `/engine-update`, `/engine-status`, `/add-pitfall`, `/engine-ingest`, `/engine-reconcile` — to the latest version. Your `engine/*.md` files are never touched.
