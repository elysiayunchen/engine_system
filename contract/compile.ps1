# Engine System - Contract compiler (v6 S3 + S3-b + review fix)
#
# Produces 3 dist files:
...
Write-Output "compile: 3 dist files (web-prompt $lines lines, runtime-law, rules.json)"
