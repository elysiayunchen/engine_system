...
> Engine System (engine_system) · Revision: 22 · Last updated: 2026-07-06
...
- 活跃任务卡：T-020(agent 检测器)、T-021(快速安装骨架)——Phase 1 通用化核心(均 paused;T-019 prompt 中立分发+engine init 已 done,Phase 0 三卡已 done)。待批决策:D-018(Phase 1 实施设计,proposed)
