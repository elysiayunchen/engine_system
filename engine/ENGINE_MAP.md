...
> Engine System (engine_system) · Revision: 34 · Last updated: 2026-07-23
...
| v6.11.5 pre-commit parser 鲁棒性 | ✅ | T-043 issue #10 P038 parse_task_patterns 支持 YAML frontmatter 多行 write-set:awk 分支扩展 in_frontmatter_block 边界 + tolower case 不敏感 + frontmatter 字段头匹配;T-044/D-032(已批准)待实施移除 legacy fallback |
| N1-N5 | ✅ | 全部达成 |
...
- 最近 change capsule：`engine/changes/CHANGE-2026-07-23-02.md`
- 活跃任务卡：无。前序: T-043 done(issue #10 P038 parser 修复) / T-042 done(issue #9 PS 5.1 LF fix + T-041 cleanup) / T-041 done(pre-commit 自身豁免) / T-040 done(v6.11.3) / T-039 done(v6.11.2) / T-038 done(v6.11.1) / T-036 done(v6.11.0 多会话锁);T-044 proposed(P037 legacy fallback 移除,depends-on D-032 approved + T-043 done)
