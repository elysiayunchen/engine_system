...
> Engine System (engine_system) · Revision: 11 · Last updated: 2026-07-03
...
- 最近 change capsule：`engine/changes/CHANGE-2026-07-03-06.md`
- 活跃任务卡：`engine/tasks/T-005.md`（v6 体系完善批次1）
- 已批准决策：`engine/decisions/D-001.md`（v6 路线 A→B 主线）、`engine/decisions/D-002.md`（S2 分形记忆）、`engine/decisions/D-003.md`（S3 契约编译）、`engine/decisions/D-004.md`（S4 驾驶舱）、`engine/decisions/D-005.md`（体系完善批次1）
