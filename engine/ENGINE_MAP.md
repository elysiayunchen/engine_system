...
> Engine System (engine_system) · Revision: 20 · Last updated: 2026-07-04
...
- 最近 change capsule：`engine/changes/CHANGE-2026-07-04-01.md`
- 活跃任务卡：T-016(Release 自动化 workflow)、T-017(版本锁定安装+完整性校验)、T-018(离线安装包)——Phase 0 发布端管道加固
