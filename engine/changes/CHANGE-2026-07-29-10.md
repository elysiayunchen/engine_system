# CHANGE-2026-07-29-10 - Engine contract migration to v6

> Created: 2026-07-29 · Status: needs-verification · Related plan: none
...
- Updated managed contract blocks (contract-version 6.17.2) in: AGENTS.md engine/SYSTEM.md engine/ENGINE_DOCTOR.md.
