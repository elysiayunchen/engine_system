...
- Static health tests and the T-080 issue regression test pass; T-080 remains behaviorally green (8/8 verify, gate PASS) but close is blocked by T-078 review evidence.
