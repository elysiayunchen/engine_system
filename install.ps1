...
$FILES = @(
  ...
  @{ src = "engine/scripts/engine-task-card.sh";   dest = "engine\scripts\engine-task-card.sh";   protect = $true }
  @{ src = "engine/scripts/engine-task-card.ps1";  dest = "engine\scripts\engine-task-card.ps1";  protect = $true }
  @{ src = "engine/scripts/engine-close.sh";       dest = "engine\scripts\engine-close.sh";       protect = $true }
  @{ src = "engine/scripts/engine-close.ps1";      dest = "engine\scripts\engine-close.ps1";      protect = $true }
