...
@'
{
  ...
  "_engine_system": "Windows PowerShell hook config generated by install.ps1. If this file already existed, the installer preserves it; run /engine-sync to merge hooks.",
  "hooks": {
    "SessionStart": [
      {
        "matcher": "*",
        "hooks": [
          {
            "type": "command",
            "command": "powershell -NoProfile -ExecutionPolicy Bypass -File engine/scripts/engine-hook-session-start.ps1",
            "timeout": 15
          }
        ]
      }
    ...
    "Stop": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "powershell -NoProfile -ExecutionPolicy Bypass -File engine/scripts/engine-hook-stop.ps1",
            "timeout": 30
          },
          {
            "type": "command",
            "command": "powershell -NoProfile -ExecutionPolicy Bypass -File engine/scripts/engine-hook-session-end.ps1",
            "timeout": 45
          }
        ]
      }
