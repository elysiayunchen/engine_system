...
FILES=(
  ...
  "engine/scripts/engine-task-card.sh:engine/scripts/engine-task-card.sh:true"
  "engine/scripts/engine-task-card.ps1:engine/scripts/engine-task-card.ps1:true"
  "engine/scripts/engine-close.sh:engine/scripts/engine-close.sh:true"
  "engine/scripts/engine-close.ps1:engine/scripts/engine-close.ps1:true"
  "engine/scripts/engine-review.sh:engine/scripts/engine-review.sh:true"
