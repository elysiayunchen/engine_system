...
echo ""
echo "推送 tag 后, GitHub Actions 会自动:"
echo "  - 从 change capsules 生成 release notes"
echo "  - 打包 plugin/ 为 tarball + zip"
echo "  - 生成 SHA256 checksums"
echo "  - 创建 GitHub Release 并上传产物"
echo ""
echo "如 workflow 失败, 可手动创建:"
